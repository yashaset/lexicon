...
class Book extends DataClass implements Insertable<Book> {
  ...
  const Book({required this.id, required this.title, required this.createdAt});
  @override
  ...
  Book copyWith({int? id, String? title, DateTime? createdAt}) => Book(
    id: id ?? this.id,
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [books, entries];
}
    ...
    : super(
        TableManagerState(
          ...
          updateCompanionCallback:
              ...
              }) => BooksCompanion(id: id, title: title, createdAt: createdAt),
